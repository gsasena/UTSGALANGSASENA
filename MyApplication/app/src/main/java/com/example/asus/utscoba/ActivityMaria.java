...
public class ActivityMaria extends Activity {
    Button b1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (ActivityCompat.checkSelfPermission(ActivityMaria.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
    ...
    private void call() {
        ...
        try{
            ...
            Toast.makeText(getApplicationContext(),"Activity Maria",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onListItemClick(ListView parent, View v, int urutan, long id) {
...

        {
            ...
            i = new Intent(ActivityMaria.this, MainActivity.class);
